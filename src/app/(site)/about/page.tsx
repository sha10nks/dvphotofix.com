  ...
  return (
    <div className="mx-auto max-w-[900px] px-6 py-10 lg:px-8">
      ...
      <p className="mt-3 text-base leading-7 text-slate-700">
        DV Photo Fix is a private-sector utility that helps you check a DV entry photo and apply safe, transparent fixes
        in your browser.
      </p>
      ...
      <div className="mt-6 grid gap-4">
        <Card>
          ...
          <CardContent className="text-[15px] leading-7 text-slate-800">
            dvphotofix.netlify.app is operated by an independent private owner. It is not affiliated with any U.S.
            government agency. If you need to reach the site operator, use the Contact page.
          </CardContent>
        </Card>
