...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Non-affiliation and limitations of dvphotofix.com.",
  alternates: {
  ...
  return (
    <div className="mx-auto max-w-[900px] px-6 py-10 lg:px-8">
      ...
      <p className="mt-3 max-w-3xl text-base leading-7 text-slate-800">
        dvphotofix.com is an independent website. It does not represent the DV Program and cannot guarantee any outcome.
